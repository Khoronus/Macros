...
function (download_model MODEL_NAME MODEL_URL MODEL_DOWNLOAD_FLAG MODEL_RELATIVE_PATH CHECKSUM)
  if (MODEL_DOWNLOAD_FLAG)
    ...
    if (NOT EXISTS ${MODEL_FILENAME})
      ...
      file(DOWNLOAD ${MODEL_URL}${MODEL_RELATIVE_PATH} ${MODEL_FILENAME}
